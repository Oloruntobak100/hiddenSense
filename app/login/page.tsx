  ...
  return (
    <>
      ...
      <p className="mt-3 text-center text-sm text-[var(--hs-muted)]">
        Skip the gate to iterate on typography, motion, and quiz flow.{` `}
        {isOfflineDemoEnabled()
          ? "Offline demo mode falls back automatically when Supabase is unavailable (`next dev`)."
          : "Supabase credentials must work unless ENABLE_OFFLINE_DEMO is set."}
      </p>
