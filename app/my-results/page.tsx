...
export default async function MyResultsPage() {
  ...
  return (
    <main className="relative min-h-[100dvh] overflow-hidden px-5 py-10 sm:px-8 sm:py-12">
      <div
        aria-hidden
      ...
      <div className="mx-auto w-full max-w-6xl">
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-white/70">
          Your past mood pairings and recommendations. Open any row to see the full reveal again.
        </p>
